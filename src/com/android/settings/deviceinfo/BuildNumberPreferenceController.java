...
public class BuildNumberPreferenceController extends AbstractPreferenceController implements
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        if (preference != null) {
            try {
                ...
                String cospVersion = getCospVersion();
                if (!cospVersion.equals("")){
                    sb.append("\n");
                    sb.append(cospVersion);
                }
    ...
    private String getCospVersion(){
        String buildDate = SystemProperties.get("org.cosp.build_date","");
        String buildType = SystemProperties.get("org.cosp.build_type","unofficial").toUpperCase();
        return buildDate.equals("") ? "" : "COSP-" + buildDate + "-" + buildType;
    }
